...
export const FloatRules: MessageFns<FloatRules> = {
  ...
  fromJSON(object: any): FloatRules {
    return {
      ...
      notIn: globalThis.Array.isArray(object?.not_in) ? object.not_in.map((e: any) => globalThis.Number(e)) : [],
...
export const Int32Rules: MessageFns<Int32Rules> = {
  ...
  toJSON(message: Int32Rules): unknown {
    ...
    if (message.notIn?.length) {
      obj.not_in = message.notIn.map((e) => Math.round(e));
    }
    if (message.example?.length) {
...
export const Int64Rules: MessageFns<Int64Rules> = {
  ...
  fromJSON(object: any): Int64Rules {
    return {
      ...
      notIn: globalThis.Array.isArray(object?.not_in) ? object.not_in.map((e: any) => globalThis.String(e)) : [],
...
export const StringRules: MessageFns<StringRules> = {
  ...
  fromJSON(object: any): StringRules {
    return {
      ...
      minLen: isSet(object.min_len) ? globalThis.String(object.min_len) : "0",
      maxLen: isSet(object.max_len) ? globalThis.String(object.max_len) : "0",
      lenBytes: isSet(object.len_bytes) ? globalThis.String(object.len_bytes) : "0",
      minBytes: isSet(object.min_bytes) ? globalThis.String(object.min_bytes) : "0",
      maxBytes: isSet(object.max_bytes) ? globalThis.String(object.max_bytes) : "0",
      ...
      notContains: isSet(object.not_contains) ? globalThis.String(object.not_contains) : "",
      in: globalThis.Array.isArray(object?.in) ? object.in.map((e: any) => globalThis.String(e)) : [],
      notIn: globalThis.Array.isArray(object?.not_in) ? object.not_in.map((e: any) => globalThis.String(e)) : [],
      ...
      uriRef: isSet(object.uri_ref) ? globalThis.Boolean(object.uri_ref) : undefined,
      ...
      ipWithPrefixlen: isSet(object.ip_with_prefixlen) ? globalThis.Boolean(object.ip_with_prefixlen) : undefined,
      ipv4WithPrefixlen: isSet(object.ipv4_with_prefixlen) ? globalThis.Boolean(object.ipv4_with_prefixlen) : undefined,
      ipv6WithPrefixlen: isSet(object.ipv6_with_prefixlen) ? globalThis.Boolean(object.ipv6_with_prefixlen) : undefined,
      ipPrefix: isSet(object.ip_prefix) ? globalThis.Boolean(object.ip_prefix) : undefined,
      ipv4Prefix: isSet(object.ipv4_prefix) ? globalThis.Boolean(object.ipv4_prefix) : undefined,
      ipv6Prefix: isSet(object.ipv6_prefix) ? globalThis.Boolean(object.ipv6_prefix) : undefined,
      hostAndPort: isSet(object.host_and_port) ? globalThis.Boolean(object.host_and_port) : undefined,
      wellKnownRegex: isSet(object.well_known_regex) ? knownRegexFromJSON(object.well_known_regex) : undefined,
  ...
  toJSON(message: StringRules): unknown {
    ...
    if (message.minLen !== undefined && message.minLen !== "0") {
      obj.min_len = message.minLen;
    }
    if (message.maxLen !== undefined && message.maxLen !== "0") {
      obj.max_len = message.maxLen;
    }
    if (message.lenBytes !== undefined && message.lenBytes !== "0") {
      obj.len_bytes = message.lenBytes;
    }
    if (message.minBytes !== undefined && message.minBytes !== "0") {
      obj.min_bytes = message.minBytes;
    }
    if (message.maxBytes !== undefined && message.maxBytes !== "0") {
    ...
    if (message.notContains !== undefined && message.notContains !== "") {
      obj.not_contains = message.notContains;
    }
    if (message.in?.length) {
      obj.in = message.in;
    }
    ...
    if (message.ipWithPrefixlen !== undefined) {
      obj.ip_with_prefixlen = message.ipWithPrefixlen;
    }
    if (message.ipv4WithPrefixlen !== undefined) {
      obj.ipv4_with_prefixlen = message.ipv4WithPrefixlen;
    }
    if (message.ipv6WithPrefixlen !== undefined) {
      obj.ipv6_with_prefixlen = message.ipv6WithPrefixlen;
    }
    if (message.ipPrefix !== undefined) {
      obj.ip_prefix = message.ipPrefix;
    }
    if (message.ipv4Prefix !== undefined) {
      obj.ipv4_prefix = message.ipv4Prefix;
    }
    if (message.ipv6Prefix !== undefined) {
      obj.ipv6_prefix = message.ipv6Prefix;
    }
    if (message.hostAndPort !== undefined) {
      obj.host_and_port = message.hostAndPort;
    }
    if (message.wellKnownRegex !== undefined) {
      obj.well_known_regex = knownRegexToJSON(message.wellKnownRegex);
    }
    if (message.strict !== undefined && message.strict !== false) {
...
export const BytesRules: MessageFns<BytesRules> = {
  ...
  fromJSON(object: any): BytesRules {
    return {
      ...
      notIn: globalThis.Array.isArray(object?.not_in)
  ...
  toJSON(message: BytesRules): unknown {
    ...
    if (message.notIn?.length) {
      obj.not_in = message.notIn.map((e) => base64FromBytes(e));
    }
    if (message.ip !== undefined) {
      obj.ip = message.ip;
    }
...
export const EnumRules: MessageFns<EnumRules> = {
  ...
  fromJSON(object: any): EnumRules {
    return {
      const: isSet(object.const) ? globalThis.Number(object.const) : 0,
      definedOnly: isSet(object.defined_only) ? globalThis.Boolean(object.defined_only) : false,
      in: globalThis.Array.isArray(object?.in) ? object.in.map((e: any) => globalThis.Number(e)) : [],
      notIn: globalThis.Array.isArray(object?.not_in) ? object.not_in.map((e: any) => globalThis.Number(e)) : [],
      example: globalThis.Array.isArray(object?.example) ? object.example.map((e: any) => globalThis.Number(e)) : [],
    };
  ...
  toJSON(message: EnumRules): unknown {
    ...
    if (message.definedOnly !== undefined && message.definedOnly !== false) {
      obj.defined_only = message.definedOnly;
    }
    if (message.in?.length) {
      obj.in = message.in.map((e) => Math.round(e));
    }
...
export const RepeatedRules: MessageFns<RepeatedRules> = {
  ...
  fromJSON(object: any): RepeatedRules {
    return {
      minItems: isSet(object.min_items) ? globalThis.String(object.min_items) : "0",
      maxItems: isSet(object.max_items) ? globalThis.String(object.max_items) : "0",
  ...
  toJSON(message: RepeatedRules): unknown {
    const obj: any = {};
    if (message.minItems !== undefined && message.minItems !== "0") {
      obj.min_items = message.minItems;
    }
    if (message.maxItems !== undefined && message.maxItems !== "0") {
      obj.max_items = message.maxItems;
    }
    if (message.unique !== undefined && message.unique !== false) {
...
export const MapRules: MessageFns<MapRules> = {
  ...
  fromJSON(object: any): MapRules {
    return {
      minPairs: isSet(object.min_pairs) ? globalThis.String(object.min_pairs) : "0",
      maxPairs: isSet(object.max_pairs) ? globalThis.String(object.max_pairs) : "0",
  ...
  toJSON(message: MapRules): unknown {
    const obj: any = {};
    if (message.minPairs !== undefined && message.minPairs !== "0") {
      obj.min_pairs = message.minPairs;
    }
    if (message.maxPairs !== undefined && message.maxPairs !== "0") {
      obj.max_pairs = message.maxPairs;
    }
    if (message.keys !== undefined) {
...
export const DurationRules: MessageFns<DurationRules> = {
  ...
  fromJSON(object: any): DurationRules {
    return {
      ...
      notIn: globalThis.Array.isArray(object?.not_in) ? object.not_in.map((e: any) => Duration.fromJSON(e)) : [],
  ...
  toJSON(message: DurationRules): unknown {
    ...
    if (message.notIn?.length) {
      obj.not_in = message.notIn.map((e) => Duration.toJSON(e));
    }
    if (message.example?.length) {
...
export const TimestampRules: MessageFns<TimestampRules> = {
  ...
  fromJSON(object: any): TimestampRules {
    return {
      ...
      ltNow: isSet(object.lt_now) ? globalThis.Boolean(object.lt_now) : undefined,
      gt: isSet(object.gt) ? fromJsonTimestamp(object.gt) : undefined,
      gte: isSet(object.gte) ? fromJsonTimestamp(object.gte) : undefined,
      gtNow: isSet(object.gt_now) ? globalThis.Boolean(object.gt_now) : undefined,
...
export const Violation: MessageFns<Violation> = {
  ...
  fromJSON(object: any): Violation {
    return {
      ...
      ruleId: isSet(object.rule_id) ? globalThis.String(object.rule_id) : "",
      message: isSet(object.message) ? globalThis.String(object.message) : "",
      forKey: isSet(object.for_key) ? globalThis.Boolean(object.for_key) : false,
    };
  },
  ...
  toJSON(message: Violation): unknown {
    ...
    if (message.ruleId !== undefined && message.ruleId !== "") {
      obj.rule_id = message.ruleId;
    }
    if (message.message !== undefined && message.message !== "") {
      obj.message = message.message;
    }
    if (message.forKey !== undefined && message.forKey !== false) {
      obj.for_key = message.forKey;
    }
    return obj;
  },
...
export const FieldPathElement: MessageFns<FieldPathElement> = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 9: {
          ...
          message.uintKey = reader.uint64().toString();
          continue;
        }
        case 10: {
          if (tag !== 82) {
  ...
  fromJSON(object: any): FieldPathElement {
    return {
      fieldNumber: isSet(object.field_number) ? globalThis.Number(object.field_number) : 0,
      fieldName: isSet(object.field_name) ? globalThis.String(object.field_name) : "",
      fieldType: isSet(object.field_type) ? fieldDescriptorProto_TypeFromJSON(object.field_type) : 1,
      keyType: isSet(object.key_type) ? fieldDescriptorProto_TypeFromJSON(object.key_type) : 1,
      valueType: isSet(object.value_type) ? fieldDescriptorProto_TypeFromJSON(object.value_type) : 1,
      index: isSet(object.index) ? globalThis.String(object.index) : undefined,
      boolKey: isSet(object.bool_key) ? globalThis.Boolean(object.bool_key) : undefined,
      intKey: isSet(object.int_key) ? globalThis.String(object.int_key) : undefined,
      uintKey: isSet(object.uint_key) ? globalThis.String(object.uint_key) : undefined,
      stringKey: isSet(object.string_key) ? globalThis.String(object.string_key) : undefined,
    };
  },
  ...
  toJSON(message: FieldPathElement): unknown {
    const obj: any = {};
    if (message.fieldNumber !== undefined && message.fieldNumber !== 0) {
      obj.field_number = Math.round(message.fieldNumber);
    }
    if (message.fieldName !== undefined && message.fieldName !== "") {
      obj.field_name = message.fieldName;
    }
    if (message.fieldType !== undefined && message.fieldType !== 1) {
      obj.field_type = fieldDescriptorProto_TypeToJSON(message.fieldType);
    }
    if (message.keyType !== undefined && message.keyType !== 1) {
      obj.key_type = fieldDescriptorProto_TypeToJSON(message.keyType);
    }
    if (message.valueType !== undefined && message.valueType !== 1) {
      obj.value_type = fieldDescriptorProto_TypeToJSON(message.valueType);
    }
    if (message.index !== undefined) {
      obj.index = message.index;
    }
    if (message.boolKey !== undefined) {
      obj.bool_key = message.boolKey;
    }
    if (message.intKey !== undefined) {
      obj.int_key = message.intKey;
    }
    if (message.uintKey !== undefined) {
      obj.uint_key = message.uintKey;
    }
    if (message.stringKey !== undefined) {
      obj.string_key = message.stringKey;
    }
    return obj;
  },
